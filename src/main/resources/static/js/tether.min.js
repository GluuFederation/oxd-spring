!function (t, e) {
    ...
    function s(t) {
        ...
        var o = e.documentElement, n = {}, i = t.getBoundingClientRect();
    ...
    function h(t, e) {
        if ("undefined" != typeof t.classList)e.split(" ").forEach(function (e) {
            ...
            var o = new RegExp("(^| )" + e.split(" ").join("|") + "( |$)", "gi"), n = p(t).replace(o, " ");
            c(t, n)
        }
    }
    ...
    function C(t, e) {
        return "scrollParent" === e ? e = t.scrollParents[0] : "window" === e && (e = [pageXOffset, pageYOffset, innerWidth + pageXOffset, innerHeight + pageYOffset]), e === document && (e = e.documentElement), "undefined" != typeof e.nodeType && !function () {
            var t = s(e), o = t, n = getComputedStyle(e);
    ...
    var z = E.Utils, i = z.getScrollParents, s = z.getBounds, a = z.getOffsetParent, l = z.extend, d = z.addClass, h = z.removeClass, g = z.updateClasses, W = z.defer, M = z.flush, f = z.getScrollBarSize, r = z.removeUtilElements, j = function () {
    ...
    !function () {
        var t = null, e = null, o = null, n = function i() {
            return "undefined" != typeof e && e > 16 ? (e = Math.min(e - 16, 250), void(o = setTimeout(i, 250))) : void("undefined" != typeof t && y() - t < 10 || ("undefined" != typeof o && (clearTimeout(o), o = null), t = y(), Y(), e = y() - t))
        };
    ...
    var F = {center: "center", left: "right", right: "left"}, H = {
        ...
        top: "bottom",
        bottom: "top"
    }, X = {top: 0, left: 0, middle: "50%", center: "50%", bottom: "100%", right: "100%"}, N = function (t, e) {
        ...
        var e = t.split(" "), o = k(e, 2), n = o[0], i = o[1];
        return {top: n, left: i}
    }, q = R, D = function (t) {
        function e(t) {
            var o = this;
        ...
        return m(e, t), O(e, [{
            ...
            key: "setOptions", value: function (t) {
                ...
                this.options = l(n, t);
                var r = this.options, s = r.element, a = r.target, f = r.targetModifier;
            ...
            key: "position", value: function () {
                ...
                if (this.enabled) {
                    ...
                    }), d = h, u = w(U(this.attachment), {
                        width: i,
                        height: r
                    }), p = w(U(o), d), c = w(this.offset, {width: i, height: r}), g = w(this.targetOffset, d);
                    u = b(u, c), p = b(p, g);
                    for (var m = h.left + p.left - u.left, v = h.top + p.top - u.top, y = 0; y < E.modules.length; ++y) {
                        var C = E.modules[y], O = C.position.call(this, {
                            left: m,
                            top: v,
                            targetAttachment: o,
                            targetPos: h,
            ...
            key: "move", value: function (t) {
                ...
                if ("undefined" != typeof this.element.parentNode) {
                    ...
                    var h = {top: "", left: "", right: "", bottom: ""}, d = function (t, o) {
                    ...
                    var g = {}, m = !1;
                    for (var i in h) {
                        var y = h[i], b = this.element.style[i];
                        b !== y && (m = !0, g[i] = y)
                    }
                    m && W(function () {
                        l(e.element.style, g)
    ...
    }(), z = E.Utils, s = z.getBounds, l = z.extend, g = z.updateClasses, W = z.defer, V = ["left", "top", "right", "bottom"];
    E.modules.push({
        position: function (t) {
            ...
            var m = [], v = l({}, i), y = l({}, this.attachment);
            return this.options.constraints.forEach(function (t) {
                var r = t.to, s = t.attachment, l = t.pin;
                "undefined" == typeof s && (s = "");
                var h = void 0, d = void 0;
                if (s.indexOf(" ") >= 0) {
                    var c = s.split(" "), g = k(c, 2);
                    d = g[0], h = g[1]
                } else h = d = s;
                var b = C(e, r);
    ...
    var z = E.Utils, s = z.getBounds, g = z.updateClasses, W = z.defer;
    E.modules.push({
        position: function (t) {
            var e = this, o = t.top, n = t.left, i = this.cache("element-bounds", function () {
                return s(e.element)
            }), r = i.height, a = i.width, f = this.getTargetBounds(), l = o + r, h = n + a, d = [];
